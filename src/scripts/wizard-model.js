...
function initModel()
{
    ...
    const folderColorPosts = folderColor.addFolder('ColorPosts').open().show()
    ...
    const folderBeams = gui.addFolder('Beams').open().show()
    const folderPosts = gui.addFolder('Posts').open().show()
